# Generated by Django 3.2.8 on 2021-12-23 06:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purity', models.CharField(blank=True, max_length=20)),
                ('manufacturer', models.CharField(max_length=50)),
                ('supplier', models.CharField(max_length=50)),
                ('state', models.CharField(choices=[('SOLID', 'Solid'), ('LIQUID', 'Liquid'), ('GAS', 'Gas')], max_length=6)),
                ('amount', models.FloatField(blank=True)),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='administration.store')),
            ],
        ),
        migrations.CreateModel(
            name='User',
